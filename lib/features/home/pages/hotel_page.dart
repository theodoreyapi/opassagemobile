...
class HotelPage extends StatefulWidget {
  ...
  @override
  State<HotelPage> createState() => _HotelsMapScreenState();
}

class _HotelsMapScreenState extends State<HotelPage> {
  ...
  Widget _buildDurationChip(String label, bool isSelected) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20),
        border: Border.all(color: isSelected ? appColor : Colors.grey.shade300),
      ),
      child: Text(
        label,
        style: TextStyle(
...
/// MODÈLE POUR LES MARQUEURS D'HÔTEL
class HotelMarker {
  final String id;
  final String name;
  final String price;
